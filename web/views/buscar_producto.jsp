<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                {
                    var texto = $(this).val();//se guarda en una variable nueva para posteriormente pasarla a search.php
            ...
            jQuery(function ($) {//funcion jquery que muestra el mensaje "Buscar amigos..." en la caja de texto
                $("#caja_busqueda").Watermark("Buscar productos...");
            });
        </script>
    ...
    <body>
        ...
        <div class="registro" style="padding-bottom: 350px;">
            ...
            <form action="producto_completo.php" method="get">
